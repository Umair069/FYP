...
public class SimpleGestureListener : MonoBehaviour, KinectGestures.GestureListenerInterface
{
	...
	public Text score;
	private int squatScore = 0;
	private int palmScore = 0;
	                              ...
	                              KinectWrapper.NuiSkeletonPositionIndex joint, Vector3 screenPos)
	{
		...
		{
			palmScore = palmScore + 1;
			score.text = palmScore.ToString();
		...
		{
            squatScore = squatScore + 1;
            score.text = squatScore.ToString();
        }
